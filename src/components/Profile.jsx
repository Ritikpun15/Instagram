          ...
          <div class="px-px md:px-3">
            ...
            <div class="flex flex-wrap -mx-px md:-mx-3">
              <div class="w-1/3 p-px md:px-3">
                <a href="#">
                  <article class="post bg-gray-100 text-white relative pb-full md:mb-6 flex justify-center">
                    <img
              ...
              <div class="w-1/3 p-px md:px-3">
                <a href="#">
                  <article class="post bg-gray-100 text-white relative pb-full flex justify-center md:mb-6">
                    <img
                      class="w-60 h-60 object-cover"
